...
## 61. Autenticação Customizada + Dashboard Admin + Testes E2E (RODADA 25)

### Fase 1: Autenticação Customizada (JWT)
- [ ] Remover dependências do Manus OAuth em server/_core/auth.ts
- [ ] Criar tabela users customizada (email, password_hash, role)
- [ ] Implementar bcrypt para hash de senhas
- [ ] Criar procedures tRPC: auth.register, auth.login, auth.logout
- [ ] Implementar geração e validação de JWT tokens
- [ ] Criar middleware customizado de autenticação
- [ ] Criar páginas Login.tsx e Register.tsx
- [ ] Testar fluxo completo de registro e login

### Fase 2: Dashboard Administrativo
- [ ] Criar página AdminDashboard.tsx
- [ ] Implementar procedures tRPC para estatísticas:
  - admin.getCalculationsStats (total, por período)
  - admin.getWhitepaperDownloads (total, por período)
  - admin.getContactSubmissions (total, pendentes)
- [ ] Criar gráficos com recharts ou similar
- [ ] Adicionar tabelas de dados recentes
- [ ] Implementar filtros por data
- [ ] Proteger rota com middleware admin

### Fase 3: Testes E2E Playwright
- [ ] Instalar Playwright: pnpm add -D @playwright/test
- [ ] Criar playwright.config.ts
- [ ] Criar teste E2E: tests/calculator.spec.ts
- [ ] Criar teste E2E: tests/whitepaper.spec.ts
- [ ] Criar teste E2E: tests/contact.spec.ts
- [ ] Executar testes: pnpm playwright test
- [ ] Validar que todos os testes passam

### Fase 4: Validação Final
- [ ] Testar autenticação customizada no browser
- [ ] Testar dashboard administrativo
- [ ] Executar suite completa de testes E2E
- [ ] Salvar checkpoint v4.0.0
